...
echo "<div id='all_messages'><div class='top'><h4 class='display-6 text-center'> Humber College </h4>
<hr><br></div>";

if(isset($_SESSION['username'])) { 

$xml=simplexml_load_file("humbercollege.xml") or die("Error");
...
?>
<hr>
  <form id="all_msg" method="post" action="humbercollege.php">
